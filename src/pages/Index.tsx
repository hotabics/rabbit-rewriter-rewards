  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-secondary/10">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
            🎯 How White Rabbit Helps on Qwasar.io
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">1. Read Task</h3>
              <p className="text-muted-foreground text-sm">
                Browse your Qwasar.io project tasks and requirements
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">2. Select Text</h3>
              <p className="text-muted-foreground text-sm">
                Highlight complex instructions or confusing requirements
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">3. Ask White Rabbit</h3>
              <p className="text-muted-foreground text-sm">
                Right-click → "Explain Step-by-Step" for clear guidance
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">4. Learn & Earn</h3>
              <p className="text-muted-foreground text-sm">
                Get clear explanations and earn XP for completed tasks
              </p>
            </div>
          </div>

          <Card className="wr-glass-card max-w-4xl mx-auto">
            <CardHeader>
              <CardTitle className="text-xl text-center">Perfect for Qwasar Students</CardTitle>
              <CardDescription className="text-center">
                Transform complex project requirements into actionable steps
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li>• Complex algorithm descriptions</li>
                    <li>• Unclear project requirements</li>
                    <li>• Technical documentation</li>
                    <li>• Implementation guidelines</li>
                    <li>• Error messages and debugging</li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-semibold mb-3 flex items-center gap-2">
                    <span className="text-lg">✨</span> AI Actions
                  </h4>
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li>• <strong>Explain Step-by-Step:</strong> Break down complex tasks</li>
                    <li>• <strong>Rewrite:</strong> Simplify technical language</li>
                    <li>• <strong>Summarize:</strong> Extract key requirements</li>
                    <li>• <strong>Translate:</strong> Convert to your native language</li>
                  </ul>
                </div>
              </div>
            </CardContent>

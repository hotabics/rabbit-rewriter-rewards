...
const Demo = () => {
  ...
  const demoTexts = [
    ...
    {
      original: `Complete an index.html file with the missing javascript code in order to replicate the famous Windows Screensaver - Bounce
...
You cannot change the value of the html, moving the box needs to be done using javascript. (Yes, JQuery is not allowed yet.)`,
      transformed: `📋 Uzdevums: Lēkājošā kastīte

🎯 Kas jādara:
1. Izveido kastīti, kas lēkā pa ekrānu kā vecajā Windows ekrānsaudzētājā
2. Kastītē ieraksti savu lietotājvārdu mazajiem burtiem
3. Kastīte pārvietojas pa diagonāli un atlec no malām

🚀 Kā tas darbojas:
• Kastīte sāk augšējā kreisajā stūrī (0, 0)
• Tā lēkā pa diagonāli (uz leju-pa labi)
• Kad sasit malu, tā maina virzienu:
  - Ja sasit apakšu → iet uz augšu
  - Ja sasit labo malu → iet pa kreisi

⚡ Ātrums: Izvēlies no 0.3 līdz 1 sekundei

🛠️ Svarīgi:
• Izmanto tikai JavaScript (bez jQuery)
• Nedrīkst mainīt HTML kodu
• Izmanto document.getElementById un setInterval`,
      mode: "Izskaidrot 5. klasei"
    }
  ];
